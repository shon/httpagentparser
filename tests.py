...
("Mozilla/5.0 (Linux; U; Android 2.2.1; fr-ch; A43 Build/FROYO) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1",
    ...
    {'dist': {'version': '2.2.1', 'name': 'Android'}, 'device' : {'name' : 'Mobile'}, 'os': {'name': 'Linux'}, 'browser': {'version': '4.0', 'name': 'Safari'}},),
("Mozilla/5.0 (iPhone; U; CPU like Mac OS X; en) AppleWebKit/420+ (KHTML, like Gecko) Version/3.0 Mobile/1A543a Safari/419.3",
    ('MacOS IPhone X', 'Safari 3.0'),
    {'flavor': {'version': 'X', 'name': 'MacOS'}, 'dist': {'version': 'X', 'name': 'IPhone'}, 'device' : {'name' : 'Mobile'}, 'browser': {'version': '3.0', 'name': 'Safari'}},),
...
("Mozilla/5.0 (iPad; CPU OS 5_0_1 like Mac OS X) AppleWebKit/534.46 (KHTML, like Gecko) Version/5.1 Mobile/9A405 Safari/7534.48.3",
    ...
    {'flavor': {'version': 'X', 'name': 'MacOS'}, 'dist': {'version': 'X', 'name': 'IPad'}, 'device' : {'name' : 'Tablet'}, 'browser': {'version': '5.1', 'name': 'Safari'}},),
...
("Mozilla/5.0 (BlackBerry; U; BlackBerry 9700; en-US) AppleWebKit/534.8+ (KHTML, like Gecko) Version/6.0.0.448 Mobile Safari/534.8+",
    ...
    {'os': {'name': 'Blackberry'}, 'device' : {'name' : 'Mobile'}, 'browser': {'version': '6.0.0.448', 'name': 'Safari'}},),
("Mozilla/5.0 (PlayBook; U; RIM Tablet OS 1.0.0; en-US) AppleWebKit/534.11+ (KHTML, like Gecko) Version/7.1.0.7 Safari/534.11+",
    ...
    {'dist': {'name': 'BlackberryPlaybook'}, 'device' : {'name' : 'Tablet'}, 'browser': {'version': '7.1.0.7', 'name': 'Safari'}},),
("Opera/9.80 (Android 2.3.5; Linux; Opera Mobi/build-1203300859; U; en) Presto/2.10.254 Version/12.00",
    ...
    {'dist': {'version': '2.3.5', 'name': 'Android'}, "device" : {"name" : "Mobile"}, 'os': {'name': 'Linux'}, 'browser': {'version': '12.00', 'name': 'Opera Mobile'}},),
("Mozilla/5.0 (Linux; U; Android 2.3.5; en-in; HTC_DesireS_S510e Build/GRJ90) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1",
    ...
    {'dist': {'version': '2.3.5', 'name': 'Android'}, 'device' : {'name' : 'Mobile'}, 'os': {'name': 'Linux'}, 'browser': {'version': '4.0', 'name': 'Safari'}},),
("Mozilla/5.0 (iPhone; U; CPU iPhone OS 5_1_1 like Mac OS X; es-es) AppleWebKit/534.46.0 (KHTML, like Gecko) CriOS/19.0.1084.60 Mobile/9B206 Safari/7534.48.3",
    ...
    {'flavor': {'version': 'X', 'name': 'MacOS'}, 'dist': {'version': 'X', 'name': 'IPhone'}, 'device' : {'name' : 'Mobile'}, 'browser': {'version': '19.0.1084.60', 'name': 'ChromeiOS'}},),
...
("Mozilla/5.0 (Android; Tablet; rv:16.0) Gecko/16.0 Firefox/16.0",
    ...
    {"dist": {"name": "Android"}, "device" : {"name" : "Tablet"}, "browser" : {"version" : "16.0", "name": "Firefox"}},),
("Mozilla/5.0 (Android; Mobile; rv:15.0) Gecko/15.0 Firefox/15.0.1",
    ("Android", "Firefox 15.0.1"),
    {"dist": {"name": "Android"}, "device" : {"name" : "Mobile"}, "browser" : {"version" : "15.0.1", "name": "Firefox"}},),
("Mozilla/5.0 (X11; Linux x86_64; rv:7.0.1) Gecko/20111106 IceCat/7.0.1",
    ("Linux", "IceCat 7.0.1"),
    {"os" : {"name": "Linux"}, "browser" : {"version" : "7.0.1", "name": "IceCat"}},),
("Opera/9.80 (Android 4.0.4; Linux; Opera Tablet/ADR-1210091050) Presto/2.11.355 Version/12.10",
    ("Android Linux 4.0.4" , "Opera Mobile 12.10"),
    {"dist": {"version": "4.0.4", "name": "Android"}, "device" : {"name" : "Tablet"}, "os": {"name": "Linux"}, "browser": {"version": "12.10", "name": "Opera Mobile"}}),
)
